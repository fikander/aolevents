...
class Event(db.Model):
    ...
    # checksum provided by the scrapper - unique id of the event on that page, contains start-end date/place/type of event
    ...
    def get_absolute_url(self):
        return ( 'events.views.view_event_show', (), {'key_id': self.key().id() } )

    @permalink
    def get_facebook_url(self):
        return ( 'events_fb.views.event_show', (), {'key_id': self.key().id() } )
